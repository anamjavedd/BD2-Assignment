...
function sortFromLowToHigh(hotelObj1, hotelObj2) {
  return hotelObj1.price - hotelObj2.price;
}

function sortFromHighToLow(hotelObj1, hotelObj2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    hotelsCopy.sort(sortFromLowToHigh);
  } else if (pricing === 'high-to-low') {
    hotelsCopy.sort(sortFromHighToLow);
  }

  res.json({ hotels: hotelsCopy });
});

function filterRatingFromLowToHigh(hotelObj1, hotelObj2) {
  return hotelObj1.rating - hotelObj2.rating;
}

function filterRatingFromHighToLow(hotelObj1, hotelObj2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    hotelsCopy.sort(filterRatingFromLowToHigh);
  } else if (rating === 'high-to-low') {
    hotelsCopy.sort(filterRatingFromHighToLow);
  }

  res.json({ hotels: hotelsCopy });
});

function filterReviewsFromLowToHigh(hotelObj1, hotelObj2) {
  return hotelObj1.reviews - hotelObj2.reviews;
}

function filterReviewsFromHighToLow(hotelObj1, hotelObj2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'low-to-high') {
    hotelsCopy.sort(filterReviewsFromLowToHigh);
  } else if (reviews === 'high-to-low') {
    hotelsCopy.sort(filterReviewsFromHighToLow);
  }
